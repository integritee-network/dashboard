...
You can reuse this component for a wide variety of queries and transactions. See [src/Transfer.js](./src/Transfer.js) for a transaction example and [src/SovereignEnclaves.js](./src/SovereignEnclaves.js) for a query example.
